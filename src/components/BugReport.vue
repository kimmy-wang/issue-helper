...
const BugReportForm = {
  ...
  methods: {
    ...
    handleCreate() {
      ...
      const withConfirm = `- [ ] I have searched the [issues](https://github.com/hd-ui/${repo}/issues) \
        ...
        `;
            ...
            window.open(
              `https://github.com/hd-ui/${repo}/issues/new?title=${title}&body=${body}${label}`,
            );
    },
              ...
              <a-col span={11}>
                ...
                >
                  {getFieldDecorator('repo', {
                    ...
                    <a-select>
                      <a-select-option key="hd-ui">hd-ui</a-select-option>
                    </a-select>,
                  )}
                </a-form-item>
              </a-col>
